<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Student_Teacherfeedback.aspx.cs" Inherits="Home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:100%">
        ...
        <tr>
            <td class="auto-style1">Module Teaches</td>
            <td class="auto-style6">
