<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Add_User.aspx.cs" Inherits="Register" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td class="auto-style6">
                <asp:DropDownList ID="ddlModule" runat="server" required="required" Enabled="False">
        ...
        <tr>
            ...
            <td class="auto-style6">
                <asp:DropDownList ID="ddlClass" runat="server" required="required" DataSourceID="SqlDataSource1" DataTextField="class" DataValueField="class" Enabled="True">
                </asp:DropDownList>
            </td>
        </tr>
        </asp:Panel>
        ...
        <tr>
            ...
            <td class="auto-style6">
                <asp:button runat="server" text="Add" class="btn btn-outline-success text-center" ID="btnAdd" OnClick="btnAdd_Click"/>
                &nbsp;&nbsp;&nbsp;&nbsp;
